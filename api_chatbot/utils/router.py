...
2. Retrieve burned area mask information for a given area and time (2020–2024 only). If the user does not specify a time range, provide the most recent data within this period.
3. Retrieve forest deforestation mask data for a given area and time (2020–2024 only).
...
- SemeyOrmany: Semey Ormany
- SemeyOrmany2: Semey Ormany 2
- NorthKZ: North KZ
- EastKZ1: East KZ
...
- forest_unique_id: The forest ID from the list above
- start_date: "YYYY-MM-DD" format (start of the period) or "2020-01-01" if not specified
- end_date: "YYYY-MM-DD" format (end of the period) or "2024-12-31" if not specified
